...
<!-- faqs -->
	...
	<div class="spec ">
			...
			<img class="img-responsive" src="${pageContext.request.contextPath}/resources/images/ab.jpg" alt="">
			</div>
			...
			<div class="col-md-4 about-right">
			<img class="img-responsive" src="${pageContext.request.contextPath}/resources/images/ab1.jpg" alt="">
			</div>
