...
import com.billip.service.MemberServiceImpl;
...
public class MemberController {
	...
	public String login(@ModelAttribute MemberVO member, HttpSession session, RedirectAttributes rttr , HttpServletResponse response) throws Exception
	{
