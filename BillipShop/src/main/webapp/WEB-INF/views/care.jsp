...
<body>
<a href="offer.html"><img src="${pageContext.request.contextPath}/resources/images/download.png" class="img-head" alt=""></a>
<div class="header">
								...
								<ul class="dropdown-menu multi">
									<div class="row">
										...
										<div class="col-sm-3 w3l">
											<a href="kitchen.html"><img src="${pageContext.request.contextPath}/resources/images/me.png" class="img-responsive" alt=""></a>
										</div>
							...
							<li class="dropdown active active1">
								...
								<ul class="dropdown-menu multi multi1">
									<div class="row">
										...
										<div class="col-sm-3 w3l">
											<a href="care.html"><img src="${pageContext.request.contextPath}/resources/images/me1.png" class="img-responsive" alt=""></a>
										</div>
										<div class="clearfix"></div>
									</div>	
								</ul>
							...
							<li class="dropdown">
								...
								<ul class="dropdown-menu multi multi2">
									<div class="row">
										...
										<div class="col-sm-3 w3l">
											<a href="hold.html"><img src="${pageContext.request.contextPath}/resources/images/me2.png" class="img-responsive" alt=""></a>
										</div>
										<div class="clearfix"></div>
									</div>	
								</ul>
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item active">
          <a href="care.html"><img class="first-slide" src="${pageContext.request.contextPath}/resources/images/ba1.jpg" alt="First slide"></a>
       
        </div>
        <div class="item">
          <a href="kitchen.html"><img class="second-slide " src="${pageContext.request.contextPath}/resources/images/ba.jpg" alt="Second slide"></a>
         
        </div>
        <div class="item">
          <a href="hold.html"><img class="third-slide " src="${pageContext.request.contextPath}/resources/images/ba2.jpg" alt="Third slide"></a>
...
<div class="kic-top ">
	...
	<div class="kic ">
		...
		<div class="col-md-4 kic-top1">
			<a href="single.html">
				<img src="${pageContext.request.contextPath}/resources/images/ki3.jpg" class="img-responsive" alt="">
			</a>
			<h6>Natural Cream</h6>
		...
		<div class="col-md-4 kic-top1">
			<a href="single.html">
				<img src="${pageContext.request.contextPath}/resources/images/ki4.jpg" class="img-responsive" alt="">
			</a>
			<h6>Shaving Kit</h6>
			<p>Nam libero tempore</p>
		</div>
		<div class="col-md-4 kic-top1">
			<a href="single.html">
				<img src="${pageContext.request.contextPath}/resources/images/ki5.jpg" class="img-responsive" alt="">
			</a>
			<h6>Makeup Kit</h6>
			<p>Nam libero tempore</p>
		</div>
				...
				<div class=" con-w3l agileinf">
							<div class="col-md-3 pro-1">
								...
								<a href="#" data-toggle="modal" data-target="#myModal1" class="offer-img">
										<img src="${pageContext.request.contextPath}/resources/images/of36.png" class="img-responsive" alt="">
									</a>
									<div class="mid-1">
										<div class="women">
							...
							<div class="col-md-3 pro-1">
								<div class="col-m">
									<a href="#" data-toggle="modal" data-target="#myModal2" class="offer-img">
										<img src="${pageContext.request.contextPath}/resources/images/of37.png" class="img-responsive" alt="">
									</a>
									<div class="mid-1">
										<div class="women">
							...
							<div class="col-md-3 pro-1">
								<div class="col-m">
									<a href="#" data-toggle="modal" data-target="#myModal3" class="offer-img">
										<img src="${pageContext.request.contextPath}/resources/images/of38.png" class="img-responsive" alt="">
									</a>
									<div class="mid-1">
										<div class="women">
							...
							<div class="col-md-3 pro-1">
								<div class="col-m">
									<a href="#" data-toggle="modal" data-target="#myModal4" class="offer-img">
										<img src="${pageContext.request.contextPath}/resources/images/of39.png" class="img-responsive" alt="">
									</a>
									<div class="mid-1">
										<div class="women">
							...
							<div class="col-md-3 pro-1">
								...
								<a href="#" data-toggle="modal" data-target="#myModal5" class="offer-img">
										<img src="${pageContext.request.contextPath}/resources/images/of40.png" class="img-responsive" alt="">
									</a>
									<div class="mid-1">
										<div class="women">
							...
							<div class="col-md-3 pro-1">
								<div class="col-m">
									<a href="#" data-toggle="modal" data-target="#myModal6" class="offer-img">
										<img src="${pageContext.request.contextPath}/resources/images/of41.png" class="img-responsive" alt="">
									</a>
									<div class="mid-1">
										<div class="women">
							...
							<div class="col-md-3 pro-1">
								<div class="col-m">
									<a href="#" data-toggle="modal" data-target="#myModal7" class="offer-img">
										<img src="${pageContext.request.contextPath}/resources/images/of42.png" class="img-responsive" alt="">
									</a>
									<div class="mid-1">
										<div class="women">
							...
							<div class="col-md-3 pro-1">
								<div class="col-m">
									<a href="#" data-toggle="modal" data-target="#myModal8" class="offer-img">
										<img src="${pageContext.request.contextPath}/resources/images/of43.png" class="img-responsive" alt="">
									</a>
									<div class="mid-1">
										<div class="women">
								...
								<a href="#" data-toggle="modal" data-target="#myModal9" class="offer-img">
										<img src="${pageContext.request.contextPath}/resources/images/of44.png" class="img-responsive" alt="">
									</a>
									<div class="mid-1">
										<div class="women">
							...
							<div class="col-md-3 pro-1">
								<div class="col-m">
									<a href="#" data-toggle="modal" data-target="#myModal10" class="offer-img">
										<img src="${pageContext.request.contextPath}/resources/images/of45.png" class="img-responsive" alt="">
									</a>
									<div class="mid-1">
										<div class="women">
											<h6><a href="single.html">Hair Color</a>(250 g)</h6>							
							...
							<div class="col-md-3 pro-1">
								<div class="col-m">
									<a href="#" data-toggle="modal" data-target="#myModal11" class="offer-img">
										<img src="${pageContext.request.contextPath}/resources/images/of46.png" class="img-responsive" alt="">
									</a>
									<div class="mid-1">
										<div class="women">
							...
							<div class="col-md-3 pro-1">
								<div class="col-m">
									<a href="#" data-toggle="modal" data-target="#myModal12" class="offer-img">
										<img src="${pageContext.request.contextPath}/resources/images/of47.png" class="img-responsive" alt="">
									</a>
									<div class="mid-1">
										<div class="women">
											<h6><a href="single.html">Lotion</a>(100 g)</h6>							
