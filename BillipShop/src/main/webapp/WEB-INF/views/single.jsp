...
<div id="picture-frame">
			<img src="${pageContext.request.contextPath}/resources/images/si.jpg" data-src="${pageContext.request.contextPath}/resources/images/si-1.jpg" alt="" class="img-responsive"/>
		</div>
										<script src="${pageContext.request.contextPath}/resources/js/jquery.zoomtoo.js"></script>
								<script>
			$(function() {
