    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item active">
          <a href="care.html"><img class="first-slide" src="${pageContext.request.contextPath}/resources/images/ba2.jpg" alt="First slide"></a>
       
        </div>
        <div class="item">
          <a href="care.html"><img class="second-slide " src="${pageContext.request.contextPath}/resources/images/ba.jpg" alt="Second slide"></a>
         
        </div>
        <div class="item">
         <a href="hold.html"> <img class="third-slide " src="${pageContext.request.contextPath}/resources/images/ba1.jpg" alt="Third slide"></a>
...
<div class="kic-top ">
	...
	<div class="kic ">
		...
		<div class="col-md-4 kic-top1">
			<a href="single.html">
				<img src="${pageContext.request.contextPath}/resources/images/ki6.jpg" class="img-responsive" alt="">
			</a>
			<h6>Clips</h6>
		...
		<div class="col-md-4 kic-top1">
			<a href="single.html">
				<img src="${pageContext.request.contextPath}/resources/images/ki7.jpg" class="img-responsive" alt="">
			</a>
			<h6>Cleaning Wear</h6>
			<p>Nam libero tempore</p>
		</div>
		<div class="col-md-4 kic-top1">
			<a href="single.html">
				<img src="${pageContext.request.contextPath}/resources/images/ki8.jpg" class="img-responsive" alt="">
			</a>
			<h6>Toothbrush</h6>
			<p>Nam libero tempore</p>
		</div>
				...
				<div class=" con-w3l agileinf">
							<div class="col-md-3 pro-1">
								...
								<a href="#" data-toggle="modal" data-target="#myModal1" class="offer-img">
										<img src="${pageContext.request.contextPath}/resources/images/of48.png" class="img-responsive" alt="">
									</a>
									<div class="mid-1">
										<div class="women">
							...
							<div class="col-md-3 pro-1">
								<div class="col-m">
									<a href="#" data-toggle="modal" data-target="#myModal2" class="offer-img">
										<img src="${pageContext.request.contextPath}/resources/images/of49.png" class="img-responsive" alt="">
									</a>
									<div class="mid-1">
										<div class="women">
							...
							<div class="col-md-3 pro-1">
								<div class="col-m">
									<a href="#" data-toggle="modal" data-target="#myModal3" class="offer-img">
										<img src="${pageContext.request.contextPath}/resources/images/of50.png" class="img-responsive" alt="">
									</a>
									<div class="mid-1">
										<div class="women">
							...
							<div class="col-md-3 pro-1">
								<div class="col-m">
									<a href="#" data-toggle="modal" data-target="#myModal4" class="offer-img">
										<img src="${pageContext.request.contextPath}/resources/images/of51.png" class="img-responsive" alt="">
									</a>
									<div class="mid-1">
										<div class="women">
							...
							<div class="col-md-3 pro-1">
								...
								<a href="#" data-toggle="modal" data-target="#myModal5" class="offer-img">
										<img src="${pageContext.request.contextPath}/resources/images/of52.png" class="img-responsive" alt="">
									</a>
									<div class="mid-1">
										<div class="women">
							...
							<div class="col-md-3 pro-1">
								<div class="col-m">
									<a href="#" data-toggle="modal" data-target="#myModal6" class="offer-img">
										<img src="${pageContext.request.contextPath}/resources/images/of53.png" class="img-responsive" alt="">
									</a>
									<div class="mid-1">
										<div class="women">
							...
							<div class="col-md-3 pro-1">
								<div class="col-m">
									<a href="#" data-toggle="modal" data-target="#myModal7" class="offer-img">
										<img src="${pageContext.request.contextPath}/resources/images/of54.png" class="img-responsive" alt="">
									</a>
									<div class="mid-1">
										<div class="women">
							...
							<div class="col-md-3 pro-1">
								<div class="col-m">
									<a href="#" data-toggle="modal" data-target="#myModal8" class="offer-img">
										<img src="${pageContext.request.contextPath}/resources/images/of55.png" class="img-responsive" alt="">
									</a>
									<div class="mid-1">
										<div class="women">
								...
								<a href="#" data-toggle="modal" data-target="#myModal9" class="offer-img">
										<img src="${pageContext.request.contextPath}/resources/images/of56.png" class="img-responsive" alt="">
									</a>
									<div class="mid-1">
										<div class="women">
							...
							<div class="col-md-3 pro-1">
								<div class="col-m">
									<a href="#" data-toggle="modal" data-target="#myModal10" class="offer-img">
										<img src="${pageContext.request.contextPath}/resources/images/of57.png" class="img-responsive" alt="">
									</a>
									<div class="mid-1">
										<div class="women">
							...
							<div class="col-md-3 pro-1">
								<div class="col-m">
									<a href="#" data-toggle="modal" data-target="#myModal11" class="offer-img">
										<img src="${pageContext.request.contextPath}/resources/images/of58.png" class="img-responsive" alt="">
									</a>
									<div class="mid-1">
										<div class="women">
							...
							<div class="col-md-3 pro-1">
								<div class="col-m">
									<a href="#" data-toggle="modal" data-target="#myModal12" class="offer-img">
										<img src="${pageContext.request.contextPath}/resources/images/of59.png" class="img-responsive" alt="">
									</a>
									<div class="mid-1">
										<div class="women">
